...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="container">
        <div class="night"></div>
        <div class="flowers">
          <div class="flower flower--1" id="flower-1">
          ...
          <div class="flower flower--2" id="flower-2">
          ...
          <div class="flower flower--3" id="flower-3">
          ...
          <div class="flower flower--4" id="flower-4">
            <div class="flower__leafs flower__leafs--2">
              <div class="flower__leaf flower__leaf--1"></div>
              <div class="flower__leaf flower__leaf--2"></div>
              <div class="flower__leaf flower__leaf--3"></div>
          ...
          <div class="flower flower--5" id="flower-5">
            <div class="flower__leafs flower__leafs--3">
              <div class="flower__leaf flower__leaf--1"></div>
              <div class="flower__leaf flower__leaf--2"></div>
              <div class="flower__leaf flower__leaf--3"></div>
          ...
          <div class="flower flower--7" id="flower-7">
            <div class="flower__leafs flower__leafs--3">
              <div class="flower__leaf flower__leaf--1"></div>
              <div class="flower__leaf flower__leaf--2"></div>
              <div class="flower__leaf flower__leaf--3"></div>
...
<script>
    ...
    function addFlower() {
        const element = document.getElemementById("flower");
