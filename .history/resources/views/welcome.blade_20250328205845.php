...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="container">
        ...
        <div class="flowers">
          ...
          <div class="flower flower--6 hidden">
            <div class="flower__leafs flower__leafs--3">
              <div class="flower__leaf flower__leaf--1"></div>
              <div class="flower__leaf flower__leaf--2"></div>
              <div class="flower__leaf flower__leaf--3"></div>
...
<script>
    ...
    const dataEspecifica = new Date(2023, 5, 12, 18, 0, 0, 0);
    ...
    function addFlower() {
        const element = document.getElementById("flower--6");
        document.element.classList.add("visible");
        document.element.remove("hidden");
    }
