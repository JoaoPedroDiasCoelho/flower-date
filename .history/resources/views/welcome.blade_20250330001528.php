...
<script>
    ...
    const waitFlowers = 15;


    function addFlower() {
        const element = document.getElementById("flowers").children[i];
        var next = element.querySelectorAll('.flower');
    }
        function adicionar() {
            var childs = document.querySelectorAll('#flowers > [id^=flower]');
            for (var i = 0; i < childs.length; i++; && const amem = Math.abs(waitFlowers + 15);) {
                if(diffDays >= waitFlowers){
                    teste();
                    ...
                    console.log("nao tem florzinha por hj")
                }
        ...
        function teste(){
            const amem = Math.abs(waitFlowers + 15);
            console.log(amem);
        }
